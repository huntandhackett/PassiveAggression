...
namespace PassiveAgression.Core.Win32
{
    class Natives
    {
        ...
        public struct SAMPR_ENCRYPTED_USER_PASSWORD_NEW
        {
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 516)]
            public byte[] crypted;

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 16)]
            public byte[] ClearSalt;
        }
        ...
        {
#pragma warning disable CS0649 // Field 'Natives.TOKEN_ELEVATION.TokenIsElevated' is never assigned to, and will always have its default value 0
            public int TokenIsElevated;
#pragma warning restore CS0649 // Field 'Natives.TOKEN_ELEVATION.TokenIsElevated' is never assigned to, and will always have its default value 0
        }
        ...
        public enum PASSWORD_UPDATE_TYPE : uint
        {
        ...
        public enum PASSWORD_UPDATE_FLAGS : uint
        {
            HasAccountName = 0x01,
            ClearText = 0x02,
            LMHash = 0x04,
            NTHash = 0x08,
            AccountUnlocked = 0x10,
            ExpirePwd = 0x20
        }
        ...
        public static int BCryptOpenAlgorithmProvider(out Bcrypt.SafeBCryptAlgorithmHandle phAlgorithm, string pszAlgId, string pszImplementation, int dwFlags)
        {
        ...
        public static int BCryptGenerateSymmetricKey(Crypto.Bcrypt.SafeBCryptAlgorithmHandle hAlgorithm, out Crypto.Bcrypt.SafeBCryptKeyHandle phKey, IntPtr pbKeyObject, int cbKeyObject, IntPtr pbSecret, int cbSecret, int flags)
        {
        ...
        public static int BCryptDecrypt(Crypto.Bcrypt.SafeBCryptKeyHandle hKey, IntPtr pbInput, int cbInput, IntPtr pPaddingInfo, IntPtr pbIV, int cbIV, IntPtr pbOutput, int cbOutput, out int pcbResult, int dwFlags)
        {
        ...
        public static int BCryptEncrypt(Crypto.Bcrypt.SafeBCryptKeyHandle hKey, IntPtr pbInput, int cbInput, IntPtr pPaddingInfo, IntPtr pbIV, int cbIV, IntPtr pbOutput, int cbOutput, out int pcbResult, int dwFlags)
        {
