...
namespace PassiveAgression.Core.Static
{
    ...
    {
        internal static uint[] dwCrc32Table = new uint[]
        {
        ...
        public const int MD5_DIGEST_LENGTH = 16;
        ...
        public const int KERB_ETYPE_RC4_MD4 = -128; // FFFFFF80
        ...
        public const int KERB_ETYPE_RC4_HMAC_OLD = -133; // FFFFFF7B
        ...
        public const string PrimaryCleartext = "Primary:CLEARTEXT";
        public const string PrimaryWDigest = "Primary:WDigest";
        public const string PrimaryKerberos = "Primary:Kerberos";
        public const string PrimaryKerberosNew = "Primary:Kerberos-Newer-Keys";
        public const string PrimaryNtlmStrongNTOWF = "Primary:NTLM-Strong-NTOWF";
